...
const IconAngleDoubleLeft = (props) => {
    ...
    return (
        <svg id={id} className={classNameList} {...rest} focusable="false" data-icon="angle-double-left" width="1rem" height="1rem" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
